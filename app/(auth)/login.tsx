...
export default function LoginScreen() {
  ...
  const onBiometricLogin = async () => {
    ...
    setValue('email', saved.email);
    setValue('password', saved.password);
    await onSubmit({ email: saved.email, password: saved.password, rememberMe: true });
  };
  ...
  return (
    <View style={s.root}>
      ...
      <ImageBackground source={AuthImages.loginProduce} style={s.bg} resizeMode="cover">
            ...
            <ScrollView
              ...
              <View style={s.card}>
                ...
                <Pressable
                  ...
                  style={({ pressed }) => [s.btnOutline, pressed && { opacity: 0.75 }]}>
              ...
              <Pressable
                ...
                <Ionicons name="flask-outline" size={15} color={Colors.primaryLight} style={{ marginRight: 6 }} />
              ...
              <Link href="/(auth)/register" asChild>
                <Pressable style={({ pressed }) => [s.registerBtn, pressed && { opacity: 0.8 }]}>
...
const s = StyleSheet.create({
  root: { flex: 1 },
  bg: { flex: 1 },
  overlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(10,18,38,0.55)' },
  safe: { flex: 1 },
  kav: { flex: 1 },
